package org.hpc.springframework.beans.factory.xml;
...
import org.hpc.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import org.hpc.springframework.beans.factory.support.BeanDefinitionRegistry;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public void loadBeanDefinition(Resource resource) throws BeanException {
        try {
            ...
            throw new BeanException("解析xml资源异常, resource: " + resource, e);
        }

    }

    @Override
    public void loadBeanDefinition(Resource... resources) throws BeanException {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (getRegistry().containsBeanDefinition(beanName)) {
                throw new BeanException("重复bean名称[" + beanName + "]");
            }
